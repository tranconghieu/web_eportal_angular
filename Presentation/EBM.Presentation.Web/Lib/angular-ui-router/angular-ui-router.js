...
(function (window, angular, undefined) {
    ...
    function $UrlRouterProvider($locationProvider, $urlMatcherFactory) {
        ...
        this.rule = function (rule) {
            ...
            //Update rule ToDo --> vu: 14/02/2017
            for (var i = 0; i < rules.length; i++) {
                if (rules[i].stateName == rule.stateName) {
                    rules[i] = rule;
                    return this;
                }
            }
         ...
         */
        this.when = function (what, handler, stateName) {
    ...
    function $StateProvider($urlRouterProvider, $urlMatcherFactory) {
        ...
        function registerState(state) {
            ...
            //if (states.hasOwnProperty(name)) throw new Error("State '" + name + "' is already defined"); //--> Note vu
            ...
            if (!state[abstractKey] && state.url) {
                $urlRouterProvider.when(state.url, ['$match', '$stateParams', function ($match, $stateParams) {
                    ...
                    if (($state.$current.navigable != state || !equalForKeys($match, $stateParams)) && !window.noReload) {
            ...
            $state.transitionTo = function transitionTo(to, toParams, options) {
                ...
                if (!isDefined(toState)) {
                    ...
                    if (!isDefined(toState)) {
                        ...
                        //throw new Error("Error ui-router");
                    }
                }
